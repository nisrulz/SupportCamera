...
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class Camera2API {

  private static final SparseIntArray ORIENTATIONS = new SparseIntArray();
  private static final String TAG = "Camera2 API";
      ...
      new ImageReader.OnImageAvailableListener() {
        ...
        @Override public void onImageAvailable(ImageReader reader) {
          mBackgroundHandler.post(
              new ImageSaver(reader.acquireNextImage(), mFile, pictureCapturedListener));
        }
      };
  ...
  private static class ImageSaver implements Runnable {
    ...
    public ImageSaver(Image image, File file, PictureCapturedListener pictureCapturedListener) {
      mImage = image;
      mFile = file;
      this.pictureCapturedListener = pictureCapturedListener;
    }
    ...
    @Override public void run() {
      ...
      try {
        ...
        pictureCapturedListener.onPictureCaptured(bitmap);
      } catch (IOException e) {
        e.printStackTrace();
      } finally {
        mImage.close();
